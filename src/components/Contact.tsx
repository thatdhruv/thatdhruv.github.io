...
const socialLinks = [
  ...
  { label: "Website", href: personal.links.website, icon: GlobeIcon },
];
  ...
  return (
    <section id="contact" className="border-t border-border/50 py-24">
      <div className="mx-auto max-w-6xl px-6 text-center">
        ...
        <h2 className="ui-section-title">Let&apos;s work together</h2>
        <p className="mx-auto mt-4 max-w-xl text-muted">
          Open to full-stack, backend, and systems engineering roles — internships
          and new grad opportunities welcome.
        </p>

        <a href={`mailto:${personal.email}`} className="ui-btn-primary mt-8">
          {personal.email}
        </a>
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-3">
          {socialLinks.map((link) => (
            <a
              ...
              className="ui-btn-secondary gap-2 px-5 py-3 text-sm"
            >
              <link.icon />
              {link.label}
            </a>
...
function GlobeIcon() {
  return (
    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5a17.92 17.92 0 01-8.716-2.247m0 0A8.966 8.966 0 013 12c0-1.777.52-3.437 1.432-4.83" />
    </svg>
  );
}
